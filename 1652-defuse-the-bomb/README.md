...
<pre style="position: relative;"><strong>Input:</strong> code = [5,7,1,4], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> code = [1,2,3,4], k = 0
...
<pre style="position: relative;"><strong>Input:</strong> code = [2,4,9,3], k = -2
